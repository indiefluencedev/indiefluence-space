      ...
      if (
        ...
        [
          ...
          gsap.to(mask, {
            ...
            onUpdate: function() {
              ...
              if (progress > 0.2) {
                gsap.to(text, { color: '#fff', opacity: 1, duration: 0.2, overwrite: 'auto' });
              }
            },
            onStart: function() {
        ...
        gsap.fromTo(
          ...
          { backgroundPositionX: "-100%", color: "#fff" },
          {
            ...
            color: "#ffeb3b",
            backgroundImage: "linear-gradient(90deg, #ffeb3b 50%, transparent 50%)",
    ...
    >
      ...
      >
        <h2 className="text-5xl md:text-7xl font-extrabold mb-8 text-white tracking-tight">
          <span className="relative overflow-hidden block" style={{ display: 'block' }}>
            <span ref={line1Ref} className="relative z-10">A creative team of digital strategists</span>
            <span ref={mask1Ref} className="absolute inset-0 bg-yellow-400 z-20" style={{ willChange: 'transform' }}></span>
          </span>
          <span className="relative overflow-hidden block" style={{ display: 'block' }}>
            <span ref={line2Ref} className="relative z-10">blending psychology and marketing</span>
            <span ref={mask2Ref} className="absolute inset-0 bg-yellow-400 z-20" style={{ willChange: 'transform' }}></span>
          </span>
          <span className="relative overflow-hidden block" style={{ display: 'block' }}>
            <span ref={line3Ref} className="relative z-10">to build brands that truly <span ref={highlightRef} style={{backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundImage: 'linear-gradient(90deg, #ffeb3b 50%, #fff 50%)', backgroundSize: '200% 100%', backgroundPositionX: '-100%'}}>connect</span>.</span>
            <span ref={mask3Ref} className="absolute inset-0 bg-yellow-400 z-20" style={{ willChange: 'transform' }}></span>
          </span>
        </h2>
