      ...
      <span className="toggle__content">
        ...
        >
          <g className="stars">
            ...
            <path fill="#fff" d="M100 100h2v2h-2z" transform="rotate(45 101 101)" />
            <path fill="#fff" d="M150 50h2v2h-2z" transform="rotate(45 151 51)" />
            <path fill="#fff" d="M200 100h2v2h-2z" transform="rotate(45 201 101)" />
            <path fill="#fff" d="M250 50h2v2h-2z" transform="rotate(45 251 51)" />
          </g>
        </svg>
      </span>
    </button>
